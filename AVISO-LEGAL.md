...
**El juego no es nuestro.** *Hyper Rally* lo publico **Konami** para MSX en 1985; su
numero de catalogo es **RC-718** y son 16 KB. Todos los derechos sobre el juego
...
El fichero `src/hyperrally.asm` es el desensamblado comentado del cartucho. Se publica
...
Si trabajaste en *Hyper Rally* o tienes derechos sobre el juego, y preferirias que este
