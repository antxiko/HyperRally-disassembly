...
**The game is not ours.** *Hyper Rally* was published by **Konami** for the MSX in 1985;
its catalogue number is **RC-718** and it is 16 KB. All rights over the game
...
The file `src/hyperrally.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Hyper Rally* or hold rights over the game, and you would rather this
